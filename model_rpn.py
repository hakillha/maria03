...
# how the var_scope is gonna be different without this decorator
@auto_reuse_variable_scope
# if called under same var_scope but different parts of the program
# still use the same variable - which basically equals to return the
# same tensors?
